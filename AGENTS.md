...
- Navigation tabs should have single ownership: Insight Board is overview/routing, Species Explorer is AI-first species and family assessment, Treatment Comparator is deterministic treatment analysis, Data Quality owns warnings, Trial Queue owns follow-up work, and Ask owns demo Q&A.
